...
# Usage
First, obtain rootfs somewhere. I recommend using proot-distro to download, then grab it at `$PREFIX/var/lib/proot-distro`. Then convert all absolute symlinks with the `hxconvert` script
