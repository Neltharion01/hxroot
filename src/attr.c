...
int (*attr_get_real)(const char *path, const char *attrname, char *attrvalue, int *valuelength, int flags);
...
int (*attr_set_real)(const char *path, const char *attrname, const char *attrvalue, const int valuelength, int flags);
...
int (*attr_remove_real)(const char *path, const char *attrname, int flags);
...
int (*attr_list_real)(const char *path, char *buffer, const int buffersize, int flags, attrlist_cursor_t *cursor);
int attr_list(const char *path, char *buffer, const int buffersize, int flags, attrlist_cursor_t *cursor) {
...
int (*attr_multi_real)(const char *path, attr_multiop_t *oplist, int count, int flags);
